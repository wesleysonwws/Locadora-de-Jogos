...
<hr>
        ...
        <form action="{{ route('jogos-update',['id'=>$jogos->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" clas="form-control" name="nome" value= "{{ $jogos->nome }}" placeholder="Digite um nome .....">
            </div>
            <br>
            <div class="form-group">
            <label for="categoria">Categoria:</label>
            <input type="text" class="form-control" name="categoria" value= "{{ $jogos->categoria }}" placeholder="Digite uma categoria para o seu jogo .....">
        </div>
        <br>
        <div class="form-group">
